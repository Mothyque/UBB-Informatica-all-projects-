...
public class CacheDemoService {
    ...
    {
        CaffeineCache springCache = (CaffeineCache) cacheManager.getCache("departments");
        if (springCache != null)
        {
            com.github.benmanes.caffeine.cache.Cache<Object, Object> caffeineCache = springCache.getNativeCache();
