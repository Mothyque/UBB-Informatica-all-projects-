...
public abstract class DBRepository<ID, E extends Entity<ID>> implements Repository<ID, E>
{
    ...
    public Iterable<E> findAll()
    {
        ...
        {
            throw new PersistenceException("Eroare la extragerea entitatilor: " + e.getMessage());
        }
        return entities;
    }
    ...
    public Optional<E> findOne(ID id)
    {
        ...
        {
            throw new PersistenceException("Eroare la extragerea entitatii: " + e.getMessage());
        }
    ...
    public Optional<E> save(E entity)
    {
        ...
        {
            throw new PersistenceException("Eroare la salvarea entitatii: " + e.getMessage());
        }
    }
    ...
    public Optional<E> delete(ID id)
    {
        ...
        if (entityToDelete.isPresent())
        {
            ...
            {
                throw new PersistenceException("Eroare la stergerea entitatii: " + e.getMessage());
            }
        }
        return Optional.empty();
    }
    ...
    public Optional<E> update(E entity)
    {
        ...
        {
            throw new PersistenceException("Eroare la actualizarea entitatii: " + e.getMessage());
        }
        return Optional.empty();
    }
    ...
    public int size()
    {
        ...
        {
            throw new PersistenceException("Eroare la calcularea dimensiunii: " + e.getMessage());
        }
        return 0;
    }
