...
void testeliminaAparitii()
{
	...
	assert(c.nrAparitii(1) == 10);
	assert(c.nrAparitii(2) == 5);

	assert(c.eliminaAparitii(3, 1) == 3);
	assert(c.nrAparitii(1) == 7);
	assert(c.eliminaAparitii(2, 2) == 2);
	assert(c.nrAparitii(2) == 3);

	assert(c.eliminaAparitii(5, 3) == 0);
	assert(c.eliminaAparitii(10, 1) == 7);
	assert(c.nrAparitii(1) == 0);
	assert(c.eliminaAparitii(5, 2) == 3);
